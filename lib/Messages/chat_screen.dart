...
import 'package:tac/Messages/chat_controller.dart';
import 'package:tac/Messages/client%20profile/client_profile_screen.dart';
import 'package:tac/data/data/constants/app_typography.dart';
import 'package:tac/data/data/constants/app_colors.dart';
import 'package:tac/data/data/constants/app_assets.dart';
import 'package:tac/modules/Messages/chat_controller.dart';
import 'package:tac/modules/Messages//client_profile_screen.dart';
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Get.to(() => ClientProfileScreen()); // Navigate on tap
              },
              child: Container(
                width: 32,
                height: 32,
