...
class CancelShiftBottomSheet extends StatefulWidget {
  @override
  State<CancelShiftBottomSheet> createState() => _CancelShiftBottomSheetState();
}

class _CancelShiftBottomSheetState extends State<CancelShiftBottomSheet> {
