...
class CloseJobBottomSheet extends StatelessWidget {
  const CloseJobBottomSheet({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Description
          Text(
            "Are you sure? You can to cancel the job. This may cause the cancelation of the job and you have to pay some charges now.",
