...
import 'package:taccontractor/modules/jobDetailsScreen/cancelled/jobDetailsScreen.dart';
...
import '../../../models/myJobs_model.dart';
 ...
 Widget jobCancelledCardWidget({required MyjobsModel job}) {
    return GestureDetector(
      onTap: () {
        Get.to(() => ContractorCancelledJobDetailsScreen(
          job: job,
        ));
      },
      child: Container(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  'CANCELLED',
                  style: AppTypography.kBold16.copyWith(color: AppColors.kACardCancelled),
                ),
              ],
            ),
            ...
            SizedBox(height: Get.height * 0.015),
             ...
             decoration: BoxDecoration(
               color: AppColors.kACardCancelled.withOpacity(0.3),
      ...
      child: Image.asset(
        ...
        fit: BoxFit.cover,
            ...
            SizedBox(height:  Get.width * 0.03,),
             ...
             decoration: BoxDecoration(
               color: AppColors.kACardCancelled.withOpacity(0.1),
              borderRadius: BorderRadius.circular(Get.width * 0.01),
              border: Border.all(
