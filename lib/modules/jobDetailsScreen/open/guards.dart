...
import 'package:taccontractor/modules/jobDetailsScreen/open/guardProfile.dart';
    ...
    child: ListView.builder(
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          onTap: () {
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>OpenGuardProfileScreen()));
          },
          child: Padding(
