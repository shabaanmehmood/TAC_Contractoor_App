...
class ContractorActiveJobDetailsScreen extends StatefulWidget {
  const ContractorActiveJobDetailsScreen({super.key});

  @override
  State<ContractorActiveJobDetailsScreen> createState() =>
      _ContractorActiveJobDetailsScreenState();
}
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildStatusChip("ACTIVE",AppColors.kblueCard.withOpacity(0.5),AppColors.kblueCard),
              ],
            ),
          ),
