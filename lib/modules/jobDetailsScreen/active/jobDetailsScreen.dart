...
class _ContractorActiveJobDetailsScreenState
    extends State<ContractorActiveJobDetailsScreen> {
  ...
  // In your ContractorActiveJobDetailsScreen class
  void _cancelJob() async {
    ...
    final result = await MyApIService().deleteJob(
        widget.job.jobId); // Make sure your job model has an id field
