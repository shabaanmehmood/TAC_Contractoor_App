...
import 'package:taccontractor/modules/jobDetailsScreen/active/guardProfile.dart';
    ...
    child: ListView.builder(
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          onTap: () {
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ActiveGuardProfileScreen()));
          },
          child: Padding(
