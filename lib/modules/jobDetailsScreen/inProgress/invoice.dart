...
// Widget inProgressInvoiceWidget(MyjobsModel job) {
//   return SingleChildScrollView(
//     padding: EdgeInsets.symmetric(horizontal: Get.height * 0.02),
//     child: Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         ...job.invoices.map((invoice) => InvoiceCard(invoice: invoice, job: job)).toList(),
...
//   const InvoiceCard({Key? key, required this.invoice, required this.job}) : super(key: key);
...
//           if (invoice.contractor != null) ...[
//             SizedBox(height: Get.height * 0.015),
//             Divider(color: AppColors.kgrey.withOpacity(0.3)),
//             SizedBox(height: Get.height * 0.01),
//             Text(
//               'Contractor Details',
...
class InProgressInvoiceScreen extends StatelessWidget {
  final MyjobsModel job;

  const InProgressInvoiceScreen({Key? key, required this.job}) : super(key: key);
