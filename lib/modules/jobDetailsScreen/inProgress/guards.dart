...
import 'package:taccontractor/modules/jobDetailsScreen/inProgress/guardProfile.dart';

Widget inProgressGuards() {
  return SizedBox(
    ...
    child: ListView.builder(
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          onTap: () {
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>InProgressGuardProfileScreen()));
          },
          child: Padding(
