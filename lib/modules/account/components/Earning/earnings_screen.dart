...
class EarningsScreen extends StatelessWidget {
          ...
          Obx(() {
            ...
            if (controller.selectedClient.value != null) {
              chips.add(_buildFilterChip(
                label: controller.selectedClient.value!,
                onRemove: () {
                  controller.selectedClient.value = null;
                },
              ));
            ...
            if (controller.startDate.value != null) {
              chips.add(_buildFilterChip(
                label: controller.startDate.value!.toString().split(' ')[0],
                onRemove: () {
                  controller.startDate.value = null;
                },
              ));
            ...
            if (controller.endDate.value != null) {
              chips.add(_buildFilterChip(
                label: controller.endDate.value!.toString().split(' ')[0],
                onRemove: () {
                  controller.endDate.value = null;
                },
              ));
            ...
            return Padding(
              padding: EdgeInsets.symmetric(
                horizontal: Get.width * 0.05, // Responsive horizontal padding
                vertical: Get.height * 0.02, // Responsive vertical padding
              ),
              child: Wrap(
                spacing: Get.width * 0.025, // Responsive horizontal gap
                runSpacing: Get.height * 0.015, // Responsive vertical gap
                children: [
                  ...chips,
  ...
  // 🔽 NEW: Helper Method to Build the Custom Filter Chips
  Widget _buildFilterChip({required String label, required VoidCallback onRemove}) {
    return GestureDetector(
      onTap: onRemove, // The entire chip is tappable to remove
      child: Container(
        padding: EdgeInsets.symmetric(
  ...
  // 🔽 NEW: Helper Method to Build the "Clear All" button
